...
public static partial class {{ResultType}}Extensions
{
    ...
    public static async ValueTask<{{ResultType}}<TResult, TError>> MapAsync<T, TError, TResult>(
        this ValueTask<{{ResultType}}<T, TError>> source,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async ValueTask<{{ResultType}}<TResult, TError>> BindAsync<T, TError, TResult>(
        this ValueTask<{{ResultType}}<T, TError>> source,
        Func<T, ValueTask<{{ResultType}}<TResult, TError>>> binder)
        where TError : IError
    {
        var result = await source.ConfigureAwait(false);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async ValueTask<{{ResultType}}<T, TError>> EnsureAsync<T, TError>(
        this ValueTask<{{ResultType}}<T, TError>> source,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async ValueTask<{{ResultType}}<T, TError>> OnSuccessAsync<T, TError>(
        this ValueTask<{{ResultType}}<T, TError>> source,
    ...
    /// <exception cref="ArgumentNullException">Thrown if action is null</exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async ValueTask<{{ResultType}}<T, TError>> OnFailureAsync<T, TError>(
        this ValueTask<{{ResultType}}<T, TError>> source,
    ...
    /// <exception cref="ArgumentNullException">Thrown if action is null</exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async ValueTask<{{ResultType}}<T, TError>> TapAsync<T, TError>(
        this ValueTask<{{ResultType}}<T, TError>> source,
        Func<T, ValueTask> action)
        where TError : IError
    {
